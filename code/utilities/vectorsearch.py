...
def get_search_client(endpoint: str, key: str, index_name: str, semantic_configuration_name:str = "semantdaphconf") -> SearchClient:
    if key is None:
...
class AzureSearch(VectorStore):
    def __init__(
        ...
        semantic_configuration_name: str = "semconfig",
